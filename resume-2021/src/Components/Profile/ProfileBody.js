  ...
  return (
    <div className="profile__body">
      <p>
        ...
        ahead of the curve and leveraging emerging technologies to build brand
        market share. The best part of my career is a lifelong learning
        commitment.
      </p>
      <br></br>
      <p>
        ...
        communication<br></br>- Well scheduled project plan and progress on
        time, on budget<br></br>- Detailed Test and delivery<br></br>
        <br></br>
